//
//  TRBox2D.mm v0.5 (two m's because it's supports Objective-C and also C++ code)
//
...
- (void)destroyRevoluteJointInWorld:(b2World*)world {
    world->DestroyJoint(self.revoluteJoint);
    self.revoluteJoint = NULL;
}
- (void)destroyPrismaticJointInWorld:(b2World*)world {
    world->DestroyJoint(self.prismaticJoint);
    self.prismaticJoint = NULL;
}
- (void)destroyDistanceJointInWorld:(b2World*)world {
    world->DestroyJoint(self.distanceJoint);
    self.distanceJoint = NULL;
}
- (void)destroyMouseJointInWorld:(b2World*)world {    
